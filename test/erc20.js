...
exports.test = function() {
  ...
  it('should return 18 for decimals', async function() {
    const decimals = await this.realityToken.decimals();
  ...
  it('should let addr 2 transfer 1.5 XRT to addr 1', async function() {
    ...
    await this.realityToken.transfer(
  ...
  it('should approve addr 3 to send 3.5 XRT from addr 1', async function() {
    ...
    await this.realityToken.approve(
      this.accounts[3],
    ...
    const allowance = await this.realityToken.allowance(
  ...
  it('should let addr 3 transfer 3 XRT from addr 1', async function() {
    ...
    await this.realityToken.transferFrom(
      this.accounts[1],
      this.accounts[2],
